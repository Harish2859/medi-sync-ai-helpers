...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (!/^\d{10}$/.test(formData.phone.replace(/[^0-9]/g, ''))) return 'Phone number is invalid';
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Join MediSync AI for personalized health insights
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            ...
            {success && (
              <div className="mb-4 p-3 bg-green-50 border border-green-100 rounded-md flex items-start">
                ...
                <p className="text-sm text-green-700">Account created successfully! Redirecting to your dashboard...</p>
              </div>
            )}
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="appearance-none block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-medisync-500 focus:border-medisync-500 sm:text-sm"
                    placeholder="••••••••"
                  />
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                  I agree to the{' '}
                  <Link to="/terms" className="font-medium text-medisync-600 hover:text-medisync-500">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="font-medium text-medisync-600 hover:text-medisync-500">
                    Privacy Policy
                  </Link>
                </label>
              </div>
